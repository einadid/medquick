<?php
// FILE: templates/_shop_admin_sidebar.php (Final Version with All Links)
// PURPOSE: A dedicated, fixed sidebar for the Shop Admin panel on desktop.
...
<div class="hidden lg:block w-64 bg-white border-r flex-shrink-0 fixed inset-y-0 left-0 z-40">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-grow p-4 space-y-1">
            ...
            <a href="inventory_add.php" class="flex items-center gap-3 px-4 py-2.5 rounded-md font-medium text-sm transition-colors <?= $current_page === 'inventory_add.php' ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' ?>">
                <i class="fas fa-plus-circle w-5 text-center"></i>
                <span>Add Stock</span>
            </a>
            <a href="manage_stock.php" class="flex items-center gap-3 px-4 py-2.5 rounded-md font-medium text-sm transition-colors <?= $current_page === 'manage_stock.php' ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' ?>">
                <i class="fas fa-boxes w-5 text-center"></i>
                <span>Manage Stock</span>
            </a>
            
            <!-- **NEW: Add New Medicine to Catalog Link** -->
            <a href="medicine_add.php" class="flex items-center gap-3 px-4 py-2.5 rounded-md font-medium text-sm transition-colors <?= $current_page === 'medicine_add.php' ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' ?>">
            ...
            <a href="orders.php" class="flex items-center gap-3 px-4 py-2.5 rounded-md font-medium text-sm transition-colors <?= $current_page === 'orders.php' ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' ?>">
                <i class="fas fa-dolly-flatbed w-5 text-center"></i>
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="w-full flex items-center space-x-3 p-2 rounded-md hover:bg-gray-100 transition-colors">
                    ...
                    <div class="flex-grow text-left">
                        ...
                        <p class="text-xs text-gray-500">Shop Admin</p>
                    </div>
